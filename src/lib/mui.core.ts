...
import {
  ...
  InitColorSchemeScript as MuiInitColorSchemeScript,
  Input as MuiInput,
  ...
  TablePaginationActions as MuiTablePaginationActions,
...
export const ClickAwayListener = createMuiNode(MuiClickAwayListener)
...
export const GlobalStyles = createMuiNode(MuiGlobalStyles)
...
export const InitColorSchemeScript = createMuiNode(MuiInitColorSchemeScript)
...
export const NoSsr = createMuiNode(MuiNoSsr)
...
export const TablePaginationActions = createMuiNode(MuiTablePaginationActions)
